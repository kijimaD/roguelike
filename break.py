...
class Score():
    ...
    def draw(self, screen):
        img = self.sysfont.render(
            "SCORE:" + str(self.score), True, (255, 255, 250))
...
def main():
    ...
    #     "C:\prog\python\pygame\\flashing.wav")    # パドルにボールが衝突した時の効果音取得
    # Ball.block_sound = pygame.mixer.Sound(
    #     "C:\prog\python\pygame\\flying_pan.wav")    # ブロックにボールが衝突した時の効果音取得
    # Ball.gameover_sound = pygame.mixer.Sound(
    #     "C:\prog\python\pygame\\badend1.wav")    # ゲームオーバー時の効果音取得
    # 描画用のスプライトグループ
